    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(blank=True, choices=[('Salarié', 'Salarié'), ('Vacataire', 'Vacataire')], max_length=12, null=True, verbose_name='Statut')),
            ],
            options={
                'verbose_name': 'IADE',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forname', models.CharField(blank=True, max_length=50, null=True)),
                ('speciality', models.CharField(blank=True, max_length=100, null=True)),
                ('phone', models.CharField(blank=True, max_length=20, null=True)),
                ('secretary', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendrier', models.ForeignKey(blank=True, default=3, null=True, on_delete=django.db.models.deletion.CASCADE, to='subdivision.calendrier', verbose_name='Calendrier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exportnum', models.IntegerField(blank=True, null=True, unique=True)),
